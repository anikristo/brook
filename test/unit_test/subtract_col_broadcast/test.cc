...
TEST(SubtractColBroadcast, Infer){

    // Read input for test files
    std::string tf_in_file = "test/unit_test/subtract_col_broadcast/tf.in";
    std::string tf_out_file = "test/unit_test/subtract_col_broadcast/tf.out";
...
int main(int argc, char **argv) {
  ...
  ::testing::GTEST_FLAG(filter) = "SubtractColBroadcast.*";
