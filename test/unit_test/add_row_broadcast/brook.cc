...
{
    brook_elemwiseadd(0, 0) = 0.970746;
    brook_elemwiseadd(0, 1) = 1.6638;
    brook_elemwiseadd(0, 2) = 2.70395;
    brook_elemwiseadd(0, 3) = 3.59535;
    brook_elemwiseadd(0, 4) = 4.53561;
    brook_elemwiseadd(0, 5) = 5.35237;
    brook_elemwiseadd(0, 6) = 6.27162;
    brook_elemwiseadd(0, 7) = 7.03015;
    brook_elemwiseadd(0, 8) = 7.85638;
