...
if __name__ == '__main__':
    ...
    # Multiplies element wise. Expected x2 = [[1, 2, 3, 4, 5, 6, 7, 8, 9], [9, 8, 7, 6, 5, 4, 3, 2, 1]]
    x_train = [
        [1, 2, 0, 0, 5, 1, 7, 5, 0],
        [0, 0, 3, 4, 3, 3, 4, 6, 0]
    ]
    ...
    y_train = [
        ...
        [0, 0, 21, 24, 15, 12, 12, 12, 0]
    ]

    # Model input and output
    x1 = tf.placeholder(shape=[2, 9], dtype=tf.float32, name='inputx')
    x2 = tf.Variable(tf.random_normal([2, 9]), name='elemwiseFactor')
    model = tf.multiply(x1, x2, name='outputx')
