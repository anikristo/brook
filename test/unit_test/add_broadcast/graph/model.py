...
if __name__ == '__main__':
    ...
    y_train = [2, 3, 1, 0, 5, 6, 8, -11, 4]

    # Model input and output
    x = tf.placeholder(dtype=tf.float32, name='inputx')
    incrementVal = tf.Variable(tf.random_normal((1, 1)), name='incrementVal')
    model = tf.add(x, incrementVal, name='outputx')
