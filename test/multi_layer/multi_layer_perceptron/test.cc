...
TEST(MultiLayerPerceptron, Infer){

    // Read input for test files
    std::string tf_in_file = "test/multi_layer/multi_layer_perceptron/tf.in";
    std::string tf_out_file = "test/multi_layer/multi_layer_perceptron/tf.out";
...
int main(int argc, char **argv) {
  ...
  ::testing::GTEST_FLAG(filter) = "MultiLayerPerceptron.*";
