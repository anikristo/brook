# File from: https://raw.githubusercontent.com/tensorflow/tensorflow/master/third_party/eigen.BUILD
...
# Note: unsupported/Eigen is unsupported and therefore not included in this list.
EIGEN_FILES = [
    "Eigen/**"
]
